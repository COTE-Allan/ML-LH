...
?>
    <div class="ml-map">
        ...
        <div class="ml-map-flex">
            <div class="ml-map-main">
                ...
                <div class="ml-map-main-details" style="display:none">
                    <div class="ml-map-main-details-container">
                        ...
                        <a class="ml-map-main-details-container-link" href=""><span class="ml-map-main-details-container-link-icon dashicons dashicons-admin-links"></span>voir sur google maps</a>
                    </div>
            ...
            <div class="ml-map-wrapper">
                <img src="<?= plugins_url("interactive-ml-map/assets/ml-map.svg") ?>" alt="Image de la carte" class="ml-map-wrapper-img style-svg">
            </div>
        </div>
    </div>

    ...
    <div class="search_jobs">
        ...
        <div class="search_keywords">
            ...
            <input type="text" name="search_keywords" id="search_keywords"
                placeholder="<?php esc_attr_e('Keywords', 'wp-job-manager'); ?>"
        ...
        <div class="search_location">
            ...
            <input type="text" name="search_location" id="search_location"
                placeholder="<?php esc_attr_e('Location', 'wp-job-manager'); ?>"
        ...
        <div class="search_remote_position">
            <input type="checkbox" class="input-checkbox" name="remote_position" id="remote_position"
                placeholder="<?php esc_attr_e('Location', 'wp-job-manager'); ?>" value="1"
                <?php checked(!empty($remote_position)); ?> />
            <label for="remote_position"
                id="remote_position_label"><?php esc_html_e('Remote positions only', 'wp-job-manager'); ?></label>
        </div>
        <?php endif; ?>
